...
(function($, window, document) {
    ...
    var IndexedList = $.IndexedList = $.Class.extend({
        ...
        caleLayout: function() {
            var self = this;
            // var withoutSearchHeight = '588px';
            var
				winheight = window.innerHeight,
				winwidth = window.innerWidth,
                rem = (100 * (winwidth / 720)).toFixed(3);
            ...
            self.el.bar.style.height = winheight*0.86-1.6*rem-5 + 'px';
            self.el.inner.style.height = winheight*0.86-1.6*rem-5 + 'px';
            console.log(self.el.bar.style.height);
